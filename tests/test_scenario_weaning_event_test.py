...
class Test(unittest.TestCase):
    ...
    def test(self):
        ...
        self.assertEqual(all(f.farm.code == 'WH' for f in females), True)
        self.assertEqual(not any(bool(f.current_cycle) for f in females), True)
        self.assertEqual(all(f.state == 'prospective' for f in females), True)
        ...
        self.assertEqual(all(f.current_cycle.state == 'mated' for f in females),
                         True)
        self.assertEqual(all(f.state == 'mated' for f in females), True)
        ...
        females = [Animal(x.id) for x in females]
        self.assertEqual(all(f.current_cycle.pregnant for f in females), True)
        self.assertEqual(
            all(f.current_cycle.state == 'pregnant' for f in females), True)
        ...
        self.assertEqual(
            all(
                FarrowingEvent(i).produced_group.lot.cost_price == Decimal(
                    '20.0') for i in farrow_events), True)
        females = [Animal(x.id) for x in females]
        self.assertEqual(not any(f.current_cycle.pregnant for f in females),
                         True)
        self.assertEqual(
            all(f.current_cycle.state == 'lactating' for f in females), True)
        self.assertEqual(all(f.state == 'mated' for f in females), True)
        self.assertEqual(females[0].current_cycle.live, 6)
        females[0].current_cycle.removed
        self.assertEqual(females[-1].current_cycle.live, (6 + len(females) - 1))
        ...
        self.assertEqual(weaning_event1.state, 'validated')
        ...
        female1.reload()
        self.assertEqual(female1.current_cycle.state, 'unmated')
        self.assertEqual(female1.current_cycle.weaned, 6)
        self.assertEqual(female1.current_cycle.removed, 0)
        ...
        self.assertEqual(lot.cost_price, Decimal('20.0000'))
        ...
        self.assertEqual(weaning_event2.state, 'validated')

        # Check female's current cycle state is 'unmated' and its weaned value is 6 and
        # the weaning event has female and lost moves but not weaned group move
        female2.reload()
        self.assertEqual(female2.current_cycle.state, 'unmated')
        self.assertEqual(female2.current_cycle.weaned, 6)
        self.assertEqual(female2.current_cycle.removed, 1)
        self.assertEqual(female2.current_cycle.weaning_event.female_move.state,
                         'done')
        female2.current_cycle.weaning_event.weaned_move
        self.assertEqual(female2.current_cycle.weaning_event.lost_move.quantity,
                         1.0)
        ...
        self.assertEqual(weaning_event3.state, 'validated')
        ...
        female3.reload()
        self.assertEqual(female3.current_cycle.state, 'unmated')
        self.assertEqual(female3.current_cycle.weaned, 8)
        self.assertEqual(female3.current_cycle.weaning_event.female_move.state,
                         'done')
        self.assertEqual(
            female3.current_cycle.weaning_event.weaned_move.quantity, 8.0)
        ...
        self.assertEqual(weaning_event4.state, 'validated')
        ...
        # weaned group moves
        female4.reload()
        self.assertEqual(female4.current_cycle.state, 'unmated')
        self.assertEqual(female4.current_cycle.weaned, 7)
        female4.current_cycle.weaning_event.female_move
        female4.current_cycle.weaning_event.weaned_move
        self.assertEqual(female4.current_cycle.weaning_event.lost_move.quantity,
                         2.0)
        self.assertEqual(
